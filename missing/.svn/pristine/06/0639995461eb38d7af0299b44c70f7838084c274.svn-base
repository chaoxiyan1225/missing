...
<body id="deal-list" data-com="pagecommon" data-page-id="100265"
	...
	<header class="navbar" style="background-color:#F08B1F;"> <span
		class="nav-header h1" style="font-size: 0.5rem;">看电影</span> </header>
	<div>
		<img src="../staticfile/images/movieIndex.jpg" style="width: 100%"/>
	</div>
				...
				<dl class="list" gaevent="common/poilist">
					<dd class="poi-list-item">
						<a class="react" href="#"
							...
							<div class="kv-line-r">
								<h6>
									<span class="stars" style="color: #F08B1F"><em
									...
									<a
										...
										<div class="dealcard dealcard-poi">
											...
											<div class="dealcard-block-right">
												...
												<div class="price">
													<span class="strong" style="color: #F08B1F">折扣价：${product.discountPrice}</span>
													<span class="strong-color" style="color: #F08B1F">元</span> <span
														class="tag"
														style="color: #fff; border-color: #F08B1F; background-color: #F08B1F;">门店价${product.productPrice}元</span>
												</div>
											</div>
										</div>
									</a>
	...
	<script type="text/javascript">
		function changeColor(obj) {
			document.getElementById(obj.id).style.color = "#F08B1F";
			for (var i = 1; i < 5; i++) {
				var temp = "option" + i;
				if (temp == obj.id)
					continue;
