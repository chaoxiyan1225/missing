		...
		<div class="unslider-carousel has-dots" data-cycle-loader="true"
			...
			<ul class="cycle-paused">
			 <!-- TODO: 解析 contentPicturePath 循环加载， 要带上commonPath-->
				<li
					style="background: url(../staticfile/images/hotpotIndex.jpg) 50% 50%/cover no-repeat rgb(255, 255, 255);"
					class="cycle-slide index_img print_material" id="">
				</li>
				<li
					style="background: url(../staticfile/images/hotPot3.jpg) 50% 50%/cover no-repeat rgb(255, 255, 255);"
				...
				<dd class="dd-padding">
					<ul>
						...
						<li>
							...
							<ul class="ul">
								<li>您在本平台所购的是商品兑换码，交易发生时兑换码将自动发送到您的微信号上</li>
