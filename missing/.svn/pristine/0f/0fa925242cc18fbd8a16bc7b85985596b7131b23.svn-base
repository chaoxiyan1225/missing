						...
						<table class="table table-hover">
							<thead>
								<tr>
									...
									<th class="span3"><span class="line"></span>交易流水号</th>
									<th class="span3"><span class="line"></span>商品名称</th>
									<th class="span3"><span class="line"></span>金额(元)</th>
									<th class="span3"><span class="line"></span>商家</th>
									<th class="span3"><span class="line"></span>交易时间</th>
									<th class="span3"><span class="line"></span>交易状态</th>
								</tr>
							</thead>
							<tbody>
								<!-- row -->
								...
								<c:forEach items="${cacheTransactions}" var="cacheTransaction">
		                         <tr>
			                        <td>${cacheTransaction.transaction.recordId}</td>
			                        <td>${cacheTransaction.transaction.outTradeNo}</td>
			                        <td>${cacheTransaction.productName}</td>
			                        <td>${cacheTransaction.transaction.recordMoney}</td>
			                        <td>${cacheTransaction.mchShopName}</td>      
			                        <td>${cacheTransaction.transaction.recordTime}</td>  
			                      <c:if test="${cacheTransaction.transaction.recordStatus==1}">
		                            <td > <span class="label label-success">已完成</span></td> 
		                          </c:if>
		                          <c:if test="${cacheTransaction.transaction.recordStatus==0}">
