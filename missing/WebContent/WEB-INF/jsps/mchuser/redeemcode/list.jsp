...
<jsp:include page="../basic/top.jsp" /> 
			...
			<div id="pad-wrapper">
				...
				<div class="table-products section">
					...
					<div class="pagination">
						...
						<ul>
							<li><a
								href="<%=request.getContextPath()%>/mchuser/toredeemcodelist?isused=${isused}&currentPage=0">&#8249&#8249</a></li>
							<li><c:if test="${currentPage>0}">
									<a
										href="<%=request.getContextPath()%>/mchuser/toredeemcodelist?isused=${isused}&currentPage=${currentPage-1}">&#8249</a>
								</c:if></li>
							<li><c:if test="${currentPage<allPages}">
									<a
										href="<%=request.getContextPath()%>/mchuser/toredeemcodelist?isused=${isused}&currentPage=${currentPage+1}">&#8250</a>
								</c:if></li>
							<li><a
								href="<%=request.getContextPath()%>/mchuser/toredeemcodelist?isused=${isused}&currentPage=${allPages}">&#8250&#8250</a></li>
						</ul>
					</div>
				</div>
				<!-- end table sample -->
    ...
    function select(s){  
    	 window.location.href="/missing/mchuser/toredeemcodelist?isused="+s; 
    };
</script>
</body>
</html>