				...
				<div class="table-products section">
							...
							<tbody>
								...
								<c:forEach items="${cacheTransactions}" var="cacheTransaction">
		                         <tr>
			                        ...
			                        <td align="center">${cacheTransaction.productName}</td>
		                            ...
		                            <td>
		                               ...
		                               <c:forEach items="${cacheTransaction.cacheMch.staffs}" var="staff">
		                           ...
		                           <td> <input type="button"  onClick="editTransaction(${cacheTransaction.transaction.recordId},${cacheTransaction.transaction.recordStatus})" class="btn-glow primary" style="width:50px;" value="保存"/></td>           
	                              </tr>
								</c:forEach>
							</tbody>
						</table>
					...
					<div class="pagination">
						...
						<ul>
							...
							<li><a
								href="<%=request.getContextPath()%>/admin/totransactionlist?currentPage=${allPages}">&#8250&#8250</a></li>
						</ul>
					</div>
				</div>
