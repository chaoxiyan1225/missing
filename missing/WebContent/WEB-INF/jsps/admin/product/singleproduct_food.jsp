...
<body class="automove" id="deal-detail" data-com="pagecommon"
	...
	<header class="navbar">
		<span class="nav-header h1"
			style="background-color: #E52010; font-size: 0.5rem;">${cacheProduct.mchUser.mchShopName}</span>
	</header>
	<div class=" clearfix ">
		<div class="unslider-carousel has-dots" data-cycle-loader="true"
			...
			<ul class="cycle-paused">
			 <!-- TODO: 解析 contentPicturePath 循环加载， 要带上commonPath-->
				<li
					style="background: url(${commonPicturePath}${cacheProduct.product.productHeadPicture}) 50% 50%/cover no-repeat rgb(255, 255, 255);"
						...
						<div class="merchant">
							<div class="biz-detail">
								<a gaevent="imt/detail/merchant" class="react" href="#">
									<h5 class="title single-line">${cacheProduct.mchUser.mchShopName}</h5>
									<div class="address single-line">
										${cacheProduct.mchUser.mchShopAddress}</div>
								</a>
							</div>
							<div class="biz-call">
								<a gaevent="imt/detail/bizPhone" data-com="phonecall"
									class="react phone"
									href="tel:${cacheProduct.mchUser.mchPhoneNum}"><i
