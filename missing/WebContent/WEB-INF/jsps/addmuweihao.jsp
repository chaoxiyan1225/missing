...
function checkMuweihaoForm(){
	...
	var jsondata={deadName:name,muweihao:muweihao,jisaoTel:jisaoTel,jisaoBeizhu:jisaoBeizhu,jisaoDate:jisaoDate,userName:userName,relation:relation};
	// 给json对象赋值
	
	$.post("<%=request.getContextPath()%>/wechatuser/muweihao/add",{muweihaoEntry:JSON.stringify(jsondata)},function(data){
...
<body style="padding-bottom: 45px;" class=" hPC">
      ...
      <!--客户端下载的图片-->
	    ...
	    <div class="u-hd-left f-left">
                <a href="./muweihao" class="J_backToPrev"><span class="u-icon i-hd-back"></span></a>
                </div>
			     <div class="u-hd-tit"><span>新增墓位号</span></div>
      		 	</header>
	
		<div class="connerdiv">
		  <form  action="./muweihao/add"method="post"  id="muweihao"  name="muweihao" method="POST">
		    <dl class="connerbox">
		      <dd><span class="form_hd"><font color="green">逝者姓名：</font></span><span class="form_td ml80">
		          <input name="deadName" maxlength="50" class="text_input" type="text"></span></dd>
		      <dd><span class="form_hd"><font color="green">墓位号：</font></span><span class="form_td ml80">
		          <input name="muweihao" maxlength="11" class="text_input" type="text" placeholder="同墓位证保持一致"></span></dd>
		          				<dd>
					<span class="form_hd"><font color="green">联系方式：</font></span><span
						class="form_td ml80"> <input name="jisaoTel" maxlength="50"
						class="text_input" type="text" ></span>
				</dd>
				<dd>
					<span class="form_hd"><font color="green">祭扫时间：</font></span><span
						...
						placeholder="阳历日期例如：20210304"></span>
				</dd>
			    <dd>
					<span class="form_hd"><font color="green">您的姓名：</font></span><span
						class="form_td ml80"> <input name="userName"
						maxlength="50" class="text_input" type="text"
						placeholder="祭祀时替您念悼文使用"></span>
				</dd>
				<dd>
					<span class="form_hd"><font color="green">与逝者关系：</font></span><span
						class="form_td ml80"> <input name="relation"
						maxlength="50" class="text_input" type="text"
						placeholder="与逝者关系说明例如：兄弟关系"></span>
				</dd>
				
		    </dl>
		      <dl class="connerbox"><dd><span><font color="green">祭扫备注说明：</font></span><textarea name="jisaoBeizhu" rows="5" class="textarea_input textarea_address"  placeholder="如有祭文要求请填写..."></textarea></dd></dl>
		      <div class="ui-btn-area">
		        <input data-commit="jisaoBeizhu"  class="btn_red" data-istempuser="false" data-loading-text="正在提交..." value="完成" type="button"  onClick="checkMuweihaoForm();">
		      </div>
		  </form>
		  </div>
