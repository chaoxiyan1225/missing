...
<body id="deal-list" data-com="pagecommon" data-page-id="100265"
	...
	<header class="navbar" style="background-color:#37A920;"> <span
		class="nav-header h1" style="font-size: 0.5rem;">休闲方式</span> </header>
	<div>
		<img src="../staticfile/images/relaxIndex.jpg" style="width: 100%"/>
	</div>
				...
				<dl class="list" gaevent="common/poilist">
					<dd class="poi-list-item">
						<a class="react" href="#"
							...
							<div class="kv-line-r">
								<h6>
									<span class="stars" style="color: #37A920"><em
									...
									<a
										...
										<div class="dealcard dealcard-poi">
											...
											<div class="dealcard-block-right">
												...
												<div class="price">
													<span class="strong" style="color: #37A920">折扣价：${product.discountPrice}</span>
													<span class="strong-color" style="color: #37A920">元</span> <span
														class="tag"
														style="color: #fff; border-color: #37A920; background-color: #37A920;">门店价${product.productPrice}元</span>
												</div>
											</div>
										</div>
									</a>
	...
	<script type="text/javascript">
		function changeColor(obj) {
			document.getElementById(obj.id).style.color = "#37A920";
			for (var i = 1; i < 5; i++) {
				var temp = "option" + i;
				if (temp == obj.id)
					continue;
