...
<script>
	...
	var abc = {
		...
		pay : function() {
			...
			var gourl = "<%=request.getContextPath()%>/wechatuser/buyproducturi?productId="+${productId};
	...
	<div class="all" id="box">
		...
		<div class="page" style="height: 100%; overflow: hidden">
			...
			<div class="main">
				...
				<div class="win">
					<div class="win_title">您将购买该商品</div>
					<div>
						<div class="win_math">
			...
			<img class="pIcon"
				src="<%=request.getContextPath()%>/staticfile/wechatimages/movie/phone/images/leftArr.png" />
			<div class="sanjiaoCover" onclick="move(this)"></div>
			<div class="bottom" style="text-align:center;">
				<div class="bottom1" style="text-align:center;">
					<button onclick="abc.buy()" style="width:100%;height:100%;background:#00ccff;border:red;font-size:50px;">购买商品</button>
				</div>
				<div class="bottom2">
				</div>
			</div>
			...
			<div
				...
				<div class="txtBox">
					...
					<tr>
						<div class="oneTxt">
							<span>1</span>
							<div>您在本平台所购的是商品兑换串码，交易发生时兑换码将自动发送到您的微信号上；</div>
						</div>
						<div class="oneTxt">
							<span>2</span>
							<div>串码自您收到时起即可在对应商家进行兑换；</div>
						</div>
						<div class="oneTxt">
							<span>3</span>
							<div>有效期是自您收到之日起45天，过期作废且购买金额不再退还；</div>
						</div>
						<div class="oneTxt">
							<span>4</span>
							<div>请根据您的需要选择购买，本平台不承担因串码过期未兑换给您带来的损失；</div>
						</div>
						<div class="oneTxt">
							<span>5</span>
							<div>当前仅支持微信支付，一次性购买多个时只能得到一个兑换码且一次性全部兑换，如需分多次兑换则请多次购买兑换码；</div>
						</div>
						<div class="oneTxt">
							<span>6</span>
							<div>为了能够顺利向您推送您购买的兑换码，购票前请务必关注平昌欢乐购官方微信！</div>
						</div>
					</tr>
					</table>
				</div>
