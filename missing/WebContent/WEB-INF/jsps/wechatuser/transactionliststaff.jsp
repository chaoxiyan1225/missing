        			...
        			<c:forEach items="${cacheTransactions}" var="cacheTransaction">
        			 	<div class="oneTxt">
            				...
            				<c:if test="${cacheTransaction.transaction.recordStatus==2}">
		                       <button type="button" class="yongyin" style="width:100px; height:30px;" onclick="window.location.href='tofinishjisidingdan?recordId=${cacheTransaction.transaction.recordId}'" >
...
function showMessage(message,type,time) {
 ...
 var tofinish = function(id){
	...
	window.location.href="<%=request.getContextPath()%>/wechatuser/tofinishjisidingdan?recordId="+id;
